module.exports = {
  ...
  "step one: check create new ranch": function(browser) {
    browser
      .waitForElementVisible("body", 1000)
      .click("#ChooseNewRanchBtn")
      .waitForElementVisible("#newRanch", 1000);
  },
  "step two: fill form ": function(browser) {
    browser
      .setValue("#name", "Rancho de prueba")
      .setValue("#address", "Quinta blabla")
      .setValue("#size", 32)
      .click("#CreateRanchBtn")
      .waitForElementVisible("#mainLayout", 3000)
