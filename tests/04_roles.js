module.exports = {
  ...
  "step one: check if roles exist": function(browser) {
    browser.waitForElementVisible("#mainLayout", 1000).click("#goRoles");
  },
  "step two: create role": function(browser) {
    browser
      .click("#addRolBtn")
      .setValue("#nombre", "Rol de rueba")
      .setValue("#price", "123456")
      .setValue("#tipo", "123456")
      .click('select[id="tipo"] option[value="1"]')
      .click("#createRoleBtn")
      .pause(1000);
  }
};
